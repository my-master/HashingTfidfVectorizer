...
from .utils import ngramize, replace, detokenize
...
class StreamSpacyTokenizer:
    ...
    def __init__(self, disable: list = None, stopwords: str = None,
    ...
    def tokenize(self, data: List[str], batch_size=10000, n_threads=1,
    ...
    def lemmatize(self, data: List[str], batch_size=10000, n_threads=1) -> \
